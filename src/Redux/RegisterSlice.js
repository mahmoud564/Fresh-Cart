...
async function RegisterApi(body){
    let response=await axios.post("https://route-ecommerce.onrender.com/api/v1/auth/signup",body)
    .catch((error)=> error.response)
    return response.data})   
export let loginSliceApi=createAsyncThunk("loginSlice/loginSliceApi",
async function loginApi(body){
    let response=await axios.post("https://route-ecommerce.onrender.com/api/v1/auth/signin",body)
    .catch((error)=> error.response)
    return response.data})   
